...
if(isset($_GET["update"]) && !empty($_GET["update"])){
    $userId = base64_decode($_GET["update"]);
}else{
...
<form class="m-5 px-5" action="<?php echo UPDATE_FROM_SUBMIT; ?>" method="POST" enctype="multipart/form-data">
  <input type="hidden" name="token" value="<?php echo base64_encode($userId) ?>" >
<h2>UPDATE NOW</h2>
